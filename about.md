Стажер Frontend-разработчик , тестовое задание ниже) 
Время на выполнение 7 дней, если будут вопросы, пиши) 
Готовое тестовое присылай на почту: AEliseeva3@alfabank.ru 
